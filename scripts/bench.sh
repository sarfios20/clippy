...
echo "Start: $current_date_time Dataset: $1 File_size: $file_size_KiB KiB Elapsed_time: $elapsed_time seconds Kib/s: $kib_per_second Kib/s Number_lines: $number_lines Lines_per_second: $lines_per_second CPU_kernel_time: $system_time seconds CPU_utilization: $cpu_utilization Max_RAM: $mem_kb Kb Exit_status: $exit_status"